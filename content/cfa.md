...
Pixels measure intensity; CFAs spatially sample color channels. This article compares Bayer's 2G:1R:1B layout (better luminance detail) with alternatives (X-Trans patterning, Foveon vertical stacking), and explains spectral response trade-offs.
...
## CFA Approaches at a Glance

```mermaid
flowchart LR
  subgraph Bayer["Bayer"]
    B1[2×2 Grid]
    B2[2G:1R:1B]
  end
  subgraph XTrans["X-Trans"]
    X1[6×6 Pattern]
    X2[Reduced moiré]
  end
  subgraph Foveon["Foveon"]
    F1[Vertical Stack]
    F2[3 layers/depth]
  end
  Light[Light] --> Bayer
  Light --> XTrans
  Light --> Foveon
  Bayer --> Demosaic1[Demosaic]
  XTrans --> Demosaic2[Demosaic]
  Foveon --> NoDemosaic[No demosaic]
```
...
![Bayer CFA pattern.](/content/cfa/Screenshot_2025-10-28_at_4.41.18_PM.png)

**Figure 1.** Bayer CFA pattern (Wikimedia).

![How Bayer CFA filters light.](/content/cfa/Screenshot_2025-10-28_at_4.41.32_PM.png)

**Figure 2.** How Bayer CFA filters light.
...
![X-Trans pattern.](/content/cfa/Screenshot_2025-12-13_at_7.33.22_PM.png)

**Figure 3.** X-Trans pattern.
...
![Foveon CFA pixel photodiode layers.](/content/cfa/Screenshot_2025-12-13_at_7.34.10_PM.png)

**Figure 4.** Foveon CFA pixel photodiode layers.
...
[3] Liles, J. M. (2017, March 3). X-trans vs Bayer: Fantastic claims and how to test them. Medium. https://medium.com/@nevermindhim/x-trans-vs-bayer-fantastic-claims-and-how-to-test-them-475b4f1b7fae

[4] X-Trans CMOS | FUJIFILM X Series & GFX - USA. https://www.fujifilm-x.com/en-us/products/x-trans-cmos/

[5] Koifman, V. (n.d.). *Fujifilm X-Trans CFA eliminates the need in OLPF*. Image Sensors World. http://image-sensors-world.blogspot.com/2013/01/fujifilm-x-trans-cfa-eliminates-need-in.html

[6] *Foveon X3 sensor*. Wikipedia. https://en.wikipedia.org/wiki/Foveon_X3_sensor
...
[8] Turner, R., & Guttosch, R. (2006). Development challenges of a new image capture. Imaging.org. https://www.imaging.org/common/uploaded%20files/pdfs/Papers/2006/ICIS-0-736/33720.pdf

[9] *Bayer filter*. Wikipedia. https://en.wikipedia.org/wiki/Bayer_filter
